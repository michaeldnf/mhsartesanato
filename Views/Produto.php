<ol class="breadcrumb">
    ...
    <a href="http://localhost/MVC/mhsartesanato/home/listar_produto/<?php echo $viewData[0]['nome_categoria'];?>"><li class="breadcrumb-item"><?php echo ucfirst($viewData[0]['nome_categoria']);?></li></a>
    <li class="breadcrumb-item active"><?php echo $viewData[0]['nome'];?></li>
</ol>

<div class="produto-container">
    <img src="http://localhost/MVC/mhsartesanato/Assets/images/produtos/<?php echo $viewData[0]['link_img'];?>.jpg">
